export const ProductPageSelectors: Record<
  "variant" | "addToCartButton" | "radioGroup" | "roleRadio",
  string
> = {
...
export const AccountPreferencesSelectors: Record<
  AccountPreferencesKeys,
  string
> = {
